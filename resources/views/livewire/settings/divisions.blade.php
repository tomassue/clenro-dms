<div>
                ...
                <div class="card-body d-flex flex-column">
                    <div class="row g-5 justify-content-between">
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-2 text-end">
                            <button type="button" class="btn btn-primary" wire:click="$dispatch('show-divisionModal')">Add Division</button>
                        </div>
                    </div>
                    <div class="mt-5">
    ...
    <!-- divisionModal -->
    <div class="modal fade" id="divisionModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="divisionModalLabel" aria-hidden="true" wire:ignore.self>
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="divisionModalLabel">{{ $editMode ? 'Update' : 'Add' }} Division</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" wire:click="clear"></button>
                </div>
                <div class="modal-body">
                    <form class="form" wire:submit="{{ $editMode ? 'updateDivision' : 'createDivision' }}">
                        <div class="col-12 mb-10">
                            <label class="required fw-bold fs-6 mb-2">Name</label>
                            <input type="text" class="form-control mb-3 mb-lg-0" wire:model="division_name" />
                            @error('division_name')
...
@script
<script>
    $wire.on('show-divisionModal', () => {
        $('#divisionModal').modal('show');
    });

    $wire.on('hide-divisionModal', () => {
