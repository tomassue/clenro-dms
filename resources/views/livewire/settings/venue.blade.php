<div>
            ...
            <div class="card card-xxl-stretch">
                ...
                <div class="card-header border-0 py-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder fs-3 mb-1">Venue</span>
                ...
                <div class="card-body d-flex flex-column">
                    <div class="row g-5 justify-content-between">
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-2 text-end">
                            <button type="button" class="btn btn-primary" wire:click="$dispatch('show-venueModal')">Add Venue</button>
                        </div>
                    </div>
                    <div class="mt-5">
                            ...
                            <table class="table table-rounded table-striped border gy-7 gs-7 align-middle">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a type="button" style="white-space: nowrap;" class="btn btn-sm btn-secondary me-2 mb-2" wire:click="readVenue({{ $item->id }})">Edit</a>
                                            <a type="button" style="white-space: nowrap;" class="btn btn-sm {{ $item->deleted_at ? 'btn-info' : 'btn-danger' }} mb-2" wire:click="{{ $item->deleted_at ? 'restoreVenue(' . $item->id . ')' : 'deleteVenue(' . $item->id . ')' }}">{{ $item->deleted_at ? 'Activate' : 'Deactivate' }}</a>
                                        </td>
                                    </tr>
                                    @empty
                                    <tr>
    ...
    @include('livewire.settings.modals.venue-modal')
</div>
